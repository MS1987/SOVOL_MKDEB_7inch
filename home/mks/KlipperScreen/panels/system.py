...
class SystemPanel(ScreenPanel):
    ...
    def restore_factory_setting(self, dialog, response_id, method):
        if response_id == Gtk.ResponseType.CANCEL:#Ĭ��û������жϣ����ܰ�ʲô����remove����Ϊ�ָ���������Ҫ��һ�£��ȴ�����Ӧ��ͣ���ڵ�ǰҳ�棬��Ҫremove�Ƚ�����
            ...
            if method == "reset_cfg" :
                ...
                if os.path.isfile(bakconf_dir_screen) :
                    ...
                    with open(current_conf_path, 'wb') as f:
                        f.write(data)
            self._gtk.remove_dialog(dialog)
            self._screen.show_popup_message("Restoring factory settings, please wait...", level=2)
            GLib.timeout_add_seconds(2, self.reset_cfg_reboot)
